...
<body>
    ...
    <form method="post" action="{{url('/cadastro/entrada')}}">
      ...
      <div class="form-group">
        ...
        <small id="descricao" class="form-text text-muted">Informe aqui a unidade de medida que você comprou desse ingrediente</small>
      </div>
      ...
      <div class="form-group">
          ...
          <small id="descricao" class="form-text text-muted">Informe aqui a quantidade que você comprou desse ingrediente</small>
        </div>
